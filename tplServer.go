...
`, TplHead, TplNoScript, dropDownServer(server), dropDownTube(server, ""), TplLinks, content, modalClearTubes(server), tplTubeFilter(), dropEditSettings(), checkUpdate(), isDisabledJobDataHighlight)
}
